...
import { LessonViewPageContent } from '@/components/catechesis/lessons/LessonViewPageContent';
import { useLesson } from '@/hooks/useLesson';

/**
 * Lesson view page - thin container component
 * Handles only routing, permissions, and page title
 * All business logic and JSX is in LessonViewPageContent
 */
export default function CatechesisLessonViewPage() {
  ...
  return <LessonViewPageContent locale={locale} id={id} />;
}

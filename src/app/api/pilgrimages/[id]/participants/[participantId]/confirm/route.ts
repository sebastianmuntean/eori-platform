...
/**
 * POST /api/pilgrimages/[id]/participants/[participantId]/confirm - Confirm a participant
 */
export async function POST(
  ...
  try {
    ...
    logError(error, { endpoint: '/api/pilgrimages/[id]/participants/[participantId]/confirm', method: 'POST' });

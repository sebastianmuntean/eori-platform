...
interface SendNotificationPageContentProps {
  locale: string;
}

/**
 * Send Notification page content component
 * Contains all the JSX/HTML that was previously in the page file
 * Separates presentation from routing and permission logic
 */
export function SendNotificationPageContent({ locale }: SendNotificationPageContentProps) {

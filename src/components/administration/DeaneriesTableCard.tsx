...
import { Deanery } from '@/hooks/useDeaneries';
import { useTranslations } from 'next-intl';

interface DeaneriesTableCardProps {
  data: Deanery[];
...
/**
 * Card component for displaying deaneries table
 * Includes table, pagination, and error handling
 */
export function DeaneriesTableCard({
  data,
  columns,
  loading,
  error,

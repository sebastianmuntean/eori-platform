...
interface EmailTemplatesTableCardProps {
  data: EmailTemplate[];
  columns: any[];
  loading: boolean;
  error: string | null;
...
/**
 * Card component for displaying email templates table
 * Includes table, pagination, and error handling
 */
export function EmailTemplatesTableCard({
  data,
  columns,
  loading,
  error,

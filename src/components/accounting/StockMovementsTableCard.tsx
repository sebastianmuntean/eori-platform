...
interface StockMovementsTableCardProps {
  data: StockMovement[];
  columns: any[];
  loading: boolean;
  error: string | null;
...
/**
 * Card component for displaying stock movements table
 * Includes table, pagination, and error handling
 */
export function StockMovementsTableCard({
  data,
  columns,
  loading,
  error,

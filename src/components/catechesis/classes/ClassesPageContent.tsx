...
export function ClassesPageContent({ locale }: ClassesPageContentProps) {
  ...
  const fetchParams = useMemo(
    ...
    [currentPage, searchTerm, parishFilter, gradeFilter, isActiveFilter]
  );

  // Fetch classes when filters or page changes
  useEffect(() => {
  ...
  }, [formData, createClass, success, showError, resetForm, fetchClasses, fetchParams, t, tCatechesis]);
  ...
  }, [selectedClass, formData, updateClass, success, showError, fetchClasses, fetchParams, t, tCatechesis]);
  ...
  }, [deleteClass, success, showError, fetchClasses, fetchParams, t, tCatechesis]);

...
interface ClassDetailsPageContentProps {
  locale: string;
  id: string;
}

/**
 * Class details page content component
 * Contains all the JSX/HTML that was previously in the page file
 * Separates presentation from routing and permission logic
 */
export function ClassDetailsPageContent({ locale, id }: ClassDetailsPageContentProps) {

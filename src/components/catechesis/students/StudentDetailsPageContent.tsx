...
interface StudentDetailsPageContentProps {
  locale: string;
  id: string;
}

/**
 * Student details page content component
 * Contains all the JSX/HTML that was previously in the page file
 * Separates presentation from routing and permission logic
 */
export function StudentDetailsPageContent({ locale, id }: StudentDetailsPageContentProps) {

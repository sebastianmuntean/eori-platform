...
/**
 * Modal component for adding a new product in pangare module
 */
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center gap-2">
              <input
                ...
                disabled={isSubmitting}
              />
              <label htmlFor="trackStock" className="text-sm font-medium">{t('trackStock') || 'Urmărire stoc'}</label>
            </div>
            {formData.trackStock && (
              <Input
        ...
        <div>
          <div className="flex items-center gap-2">
            <input
              ...
              disabled={isSubmitting}
            />
            <label htmlFor="isActive" className="text-sm font-medium">{t('active') || 'Activ'}</label>
          </div>
        </div>

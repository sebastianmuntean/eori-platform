-- Script SQL pentru copierea directă a utilizatorilor
-- 
-- INSTRUCȚIUNI:
--   1. Modifică connection string-ul LOCAL de mai jos
--   2. Rulează acest script pe baza LOCALĂ pentru a genera INSERT statements
--   3. Copiază output-ul și rulează-l pe baza Neon
--
-- SAU folosește:
--   psql "postgresql://postgres:superuser@192.168.1.129:5433/eori_platform" -f database/scripts/copy_users_direct.sql > users_to_neon.sql
--   Apoi: psql $NEON_DATABASE_URL -f users_to_neon.sql

\set ON_ERROR_STOP on

\echo '-- ============================================'
\echo '-- Copy Users to Neon'
\echo '-- Generated: ' `date`
\echo '-- ============================================'
\echo ''
\echo 'BEGIN;'
\echo ''
\echo '-- Delete existing users from Neon (optional)'
\echo '-- Uncomment the lines below if you want to delete existing users first'
...
\echo 'COMMIT;'
\echo ''
\echo '-- Done! Users copied successfully.'
